...
namespace std { // NOLINT(cert-dcl58-cpp)
  ...
  nullptr_t; // NOLINT(modernize-use-using)
  typedef decltype(sizeof(void*))
  size_t; // NOLINT(modernize-use-using)
...
// - relational operators as free functions - taking const char* as one of the params
  ...
  private:
    static DOCTEST_CONSTEXPR size_type
    len = 24;      //!OCLINT avoid private static members
    static DOCTEST_CONSTEXPR size_type
    last = len - 1; //!OCLINT avoid private static members
    ...
    noexcept { return (buf[last] & 128) == 0; }
...
struct DOCTEST_INTERFACE SubcaseSignature
{
  ...
  namespace detail {
    ...
    forward(typename types::remove_reference<T>::type &t)
